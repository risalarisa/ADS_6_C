...
if(isset($_POST['id'])){
	...
	$cek = mysql_query("SELECT id_laporan FROM data_laporan_orang WHERE id_laporan='$id'") or die(mysql_error());
	...
	if(mysql_num_rows($cek) == 0){
		...
		$del = mysql_query("DELETE FROM data_laporan_orang WHERE id_laporan='$id'");
		
		//jika query DELETE berhasil
		if($del){
			
			echo 'Data siswa berhasil di hapus! ';		//Pesan jika proses hapus berhasil
			echo '<a href="laporan.php">Kembali</a>';	//membuat Link untuk kembali ke halaman beranda
