...
--
-- Host: 127.0.0.1
-- Generation Time: May 10, 2018 at 05:58 PM
...
(1, 'tas', 'merah', '20', 'cantik', '2015-11-28', 'tolong temukan', '', 'yang punya tas', 131212, 1231311, 'jl. dimana mana boleh');
...
INSERT INTO `data_laporan_orang` (`id_laporan`, `nama_orang`, `jk`, `umur`, `tinggi`, `tanggalhilang`, `pakaian`, `keterangan`, `foto`, `namapelapor`, `noktp`, `notelpon`, `alamatpelapor`) VALUES
(5, 'rara', 'perempuan', 31, 156, '2015-04-04', 'ungu', 'enggak tau', '', 'cinta', 1233, 1233, 'jl jalan');
...
--
ALTER TABLE `data_laporan_orang`
  MODIFY `id_laporan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;COMMIT;
